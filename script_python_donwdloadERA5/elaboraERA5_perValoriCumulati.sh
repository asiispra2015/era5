...
# - traformazione in grigliato lanlot regolare
# - conversione da metri a mm (mulc,1000) 
# - annullare (zero mm) la precipitazione sotto 1mm di precipitazione 
# - estraggo dati per la sola Italia
cdo sellonlatbox,${ITALIA} -setrtoc,-10000,0.99999,0 -mulc,1000 -remapbil,${GRIGLIA} -daysum -seldate,${YYMMDD_I},${YYMMDD_F}  ${out} ${1%.nc}_it.nc
